...
new Vue({
    ...
    <Layout>
      <Scene>
        ...
        <a-entity material="color:white; emissive: #faf9ff; emissiveIntensity: 2" class="chandelier" position="0 -0.70 0" scale="0.001 0.001 0.001" obj-model="obj: #chandelier"></a-entity>
          <a-entity light="type: point; intensity: 0.6; color: #faf9ff; castShadow: true " position="0 -0.7 0" ></a-entity>
          <a-entity light="type: ambient; intensity: 0.5; color: #faf9ff "></a-entity>  
        </Ceiling>
        <Wall position="0 0 -5"/>
